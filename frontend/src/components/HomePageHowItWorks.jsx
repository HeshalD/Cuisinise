        ...
        <div className="flex items-center justify-between gap-16">
          ...
          <div className="flex-1 relative ml-[100px]">
            <div className="grid grid-cols-2 gap-6 max-w-2xl">
              {/* Top Left - Image 1 */}
              <div className="rounded-tr-[50px] rounded-bl-[50px] overflow-hidden shadow-xl bg-gray-800 h-[400px] w-[300px] self-end justify-self-end hover:-rotate-6 transition-all duration-300">
              ...
              {/* Top Right - Image 2 */}
              <div className="rounded-tl-[50px] rounded-br-[50px] overflow-hidden shadow-xl bg-gray-800 h-[250px] w-[400px] self-end justify-self-start hover:-rotate-6 transition-all duration-300">
                <div className="w-full h-full flex items-center justify-center">
              ...
              {/* Bottom Left - Image 3 */}
              <div className="rounded-tl-[50px] rounded-br-[50px] overflow-hidden shadow-xl bg-gray-800 h-[250px] w-[400px] self-start justify-self-end hover:rotate-6 transition-all duration-300">
                <div className="w-full h-full flex items-center justify-center">
              ...
              <div className="rounded-tr-[50px] rounded-bl-[50px] overflow-hidden shadow-xl bg-gray-800 h-[400px] w-[300px] self-start justify-self-start hover:rotate-6 transition-all duration-300">
                <div className="w-full h-full flex items-center justify-center">
